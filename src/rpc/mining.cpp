...
static UniValue getblocktemplate(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "    https://github.com/DigiByte-Core/bips/blob/master/bip-0022.mediawiki\n"
            "    https://github.com/DigiByte-Core/bips/blob/master/bip-0023.mediawiki\n"
            "    https://github.com/DigiByte-Core/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
            "    https://github.com/DigiByte-Core/bips/blob/master/bip-0145.mediawiki\n"
