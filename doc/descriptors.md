...
-`xpub` encoded extended public key or `xprv` encoded private key (as defined in [BIP 32](https://github.com/DigiByte-Core/bips/blob/master/bip-0032.mediawiki)).
...
- P2SH addresses (base58, of the form `3...`, defined in [BIP 13](https://github.com/DigiByte-Core/bips/blob/master/bip-0013.mediawiki)).
- Segwit addresses (bech32, of the form `bc1...`, defined in [BIP 173](https://github.com/DigiByte-Core/bips/blob/master/bip-0173.mediawiki)).
