...
(https://github.com/DigiByte-Core/bips/blob/master/bip-0130.mediawiki)
...
(https://github.com/DigiByte-Core/bips/blob/master/bip-0125.mediawiki).
...
notes of v0.11.0](https://github.com/DigiByte-Core/digibyte/blob/v0.11.0/doc/release-notes.md#block-file-pruning).

`NODE_BLOOM` service bit
------------------------

Support for the `NODE_BLOOM` service bit, as described in [BIP
111](https://github.com/DigiByte-Core/bips/blob/master/bip-0111.mediawiki), has been
...
* OP_NOP2 has been renamed to OP_CHECKLOCKTIMEVERIFY by [BIP 65](https://github.com/DigiByte-Core/bips/blob/master/bip-0065.mediawiki)
