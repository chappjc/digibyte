...
compatible peers.
[BIP 152](https://github.com/DigiByte-Core/bips/blob/master/bip-0152.mediawiki)
...
[Pull request](https://github.com/DigiByte-Core/digibyte/pull/8035/files), [BIP 32](https://github.com/DigiByte-Core/bips/blob/master/bip-0032.mediawiki)
...
141](https://github.com/DigiByte-Core/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/DigiByte-Core/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/DigiByte-Core/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/DigiByte-Core/bips/blob/master/bip-0145.mediawiki) are
...
Witness)] (https://github.com/DigiByte-Core/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/DigiByte-Core/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/DigiByte-Core/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/DigiByte-Core/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/DigiByte-Core/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/DigiByte-Core/digibyte/pull/7762).
